...
object ChainedStreamTransformer {
  ...
  implicit def chainedStreamFitOperation[
      L <: StreamTransformer[L], R <: StreamTransformer[R], I, T, M](
      implicit leftFitOperation: StreamFitOperation[L, I, M],
      leftTransformOperation: TransformDataStreamOperation[L, I, T],
      rightFitOperation: StreamFitOperation[R, T, M])
  : StreamFitOperation[ChainedStreamTransformer[L, R], I, M] = {
    new StreamFitOperation[ChainedStreamTransformer[L, R], I, M] {
      override def fit(
          instance: ChainedStreamTransformer[L, R],
          fitParameters: ParameterMap,
          input: DataStream[I]): DataStream[M] = {
